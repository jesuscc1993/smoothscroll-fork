...
(function (window, undefined) {
  ...
  function byClass(cname) {
    return document.getElementsByClassName(cname);
  }
  function byTag(tag, base) {
    return (base || document).getElementsByTagName(tag || '*');
  }
  ...
  function isCheckbox(key) {
    var re =
      /^(?:keyboardSupport|touchpadSupport|middleMouse|pulseAlgorithm|fixedBackground)$/;
    return re.test(key);
  }
